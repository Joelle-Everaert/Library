    ...
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center bg-gray-800">
      <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-10 h-10 text-gray-800 p-2 bg-yellow-500 rounded-full" viewBox="0 0 24 24">
